    ...
    public void InitalLizeListenner()
    {
        callbackMethon = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int dayOfMonth) {
                ...
                editText.setText("https://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=a5452bbd4fe6d3a0e4fc3769c1e01715&targetDt=" + date);
            }
        };
    }
